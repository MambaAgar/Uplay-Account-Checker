...
class ubiapi{
	...
	function __construct($credsemail,$credspass,$credsb64){
		if($credspass == null && $credsb64 != null){
			$this->debugReport(__FUNCTION__,"","green");
	...
	public function login($showraw){
		...
		if($showraw == 1){
			$this->debugReport(__FUNCTION__,"Raw response (not decoded):<b>".$orginaloutput."</b>","blue");
		}
		if($showraw == 2){
 ...
 $uname= $json['username'];
		$this->debugReport(__FUNCTION__,"Welcome, $uname","green");
